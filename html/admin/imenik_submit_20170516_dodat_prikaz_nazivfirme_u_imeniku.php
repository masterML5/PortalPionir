<?php
  ...
  {         // It's a new story
    $query = "insert into imenik 
                (sifrad, prezime, ime, sifoj, nazoj, email, tel_mobilni, tel_fiksni, tel_lokal, lice_sluzba, uneo, datum_unosa)
              values 
				('$sifrad', '$prezime', '$ime', '$sifoj', '$nazoj', '$email', '$tel_mobilni', '$tel_fiksni', '$tel_lokal', $lice_sluzba, '".
