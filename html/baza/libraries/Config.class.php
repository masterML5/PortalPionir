        ...
        if ($this->get('CheckConfigurationPermissions')) {
            ...
            if (!($perms === false) && ($perms & 2)) {
                ...
                if ($this->get('PMA_IS_WINDOWS') == 0) {
                    $this->source_mtime = 0;
                    /* Zatvorio Zoki 24.04.2015, jer ponekad nije radilo. 
					die(__('Wrong permissions on configuration file, should not be world writable!')); 
					https://community.apachefriends.org/f/viewtopic.php?p=199869&sid=261ed00bd80eaffdaee4a3b66f0ec211 
					http://sourceforge.net/p/phpmyadmin/mailman/message/29567707/
