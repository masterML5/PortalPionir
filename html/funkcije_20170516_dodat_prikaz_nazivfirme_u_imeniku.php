...
$query_kat = 'select * from kategorije where kategorija like "'.$ckategorija.'"';
...
$query = 'select * from vesti where kategorija like "'.$ckategorija.'" and prikaz=1 order by datum desc, redosled desc limit 10';
