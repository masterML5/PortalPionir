g_l=[];g_l.MONTHS=["Januar","Februar","Mart","April","Maj","Jun","Jul","Avgust","Septembar","Oktobar","Novembar","Decembar"];
g_l.DAYS_3=["N","P","U","S","C","P","S"];g_l.MONTH_FWD="Naredni mesec";
g_l.MONTH_BCK="Prethodni mesec";
g_l.YEAR_FWD="Naredna godina";
g_l.YEAR_BCK="Prethodna godina";
...
{
	var h=document,e,i,b,a,f,c,g;e=h.createElement("div");if(this.oConfiguration.isStripped){this.setC(e,"boxMainStripped")}else{this.setC(e,"boxMain")}this.boxMain=e;i=h.createElement("div");b=h.createElement("div");a=h.createElement("div");f=h.createElement("div");c=h.createElement("div");g=h.createElement("div");this.setC(b,"clearfix");this.setC(g,"clearfix");this.setC(i,"boxMainInner");
...
{b=g.createElement("div");e=g.createTextNode(f[c]);this.setC(b,"weekDay");b.appendChild(e);a.appendChild(b)}
...
{if(typeof(this.repopulationDelegate)=="function"){this.repopulationDelegate()}};
JsDatePick.prototype.populateMainBox=function(h)
{
	...
	for(e=0;e<m;e++)
	{
		...
		while(j.getMonth()==n)
		{
			...
			if(c==7){if(g_jsDatePickDirectionality=="ltr"){g.style.marginRight="0px"}else{g.style.marginLeft="0px"}}
			if(this.isToday(j)){g.setAttribute("isToday",1)}
			if(this.oConfiguration.limitToToday)
			{
				if(!this.isAvailable(this.currentYear,this.currentMonth,parseInt(j.getDate())))
				{k=true;g.setAttribute("isJsDatePickDisabled",1)}
			}
			g.onmouseover=function()
			{
				var d=JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")),i;
				i=d.getCurrentColorScheme();
				if(parseInt(this.getAttribute("isSelected"))==1){return}
				if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){return}
				if(parseInt(this.getAttribute("isToday"))==1){d.setC(this,"dayOverToday");
			...
			g.onmousedown=function()
			{
				...
				if(parseInt(this.getAttribute("isToday"))==1)
				{
					d.setC(this,"dayDownToday");this.style.background="url("+d.oConfiguration.imgPath+i+"_dayDown.gif) left top no-repeat"
				}
				else
				{
					d.setC(this,"dayDown");
			...
			g.onmouseup=function()
			{
				...
				i=d.getCurrentColorScheme();
				if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){return}
				if(parseInt(this.getAttribute("isToday"))==1){d.setC(this,"dayNormalToday");
			...
			if(this.isSelectedDay(j.getDate()))
			{
				...
				this.flag_DayMarkedBeforeRepopulation=true;this.lastMarkedDayObject=g;
				...
				{
					this.setC(g,"dayDown");g.style.background="url("+this.oConfiguration.imgPath+this.oConfiguration.cellColorScheme+"_dayDown.gif) left top no-repeat"
				}
			}
			else
			{
...
JsDatePick.prototype.setSelectedDay=function(a)
{
	...
	this.currentMonth=a.month;this.currentYear=a.year;
	this.repopulateMainBox()
};
...
JsDatePick.prototype.getSelectedDayFormatted=function()
{
	if(this.flag_aDayWasSelected)
	{
		...
		a=a.replace("%y",this.selectedDayObject.year.toString().substr(2,2));return a
	}
	else{return false}
};
JsDatePick.prototype.setDaySelection=function(a)
{
	...
	this.lastMarkedDayObject=a;a.setAttribute("isSelected",1);
